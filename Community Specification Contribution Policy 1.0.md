...
The issue life cycle is mainly driven by the Maintainer. All issue types follow the same general life cycle. Differences are noted below.
...
**3.1   Fork the Repository, modify the Specification to Address the Issue.**
...
o   When a review is approved, the reviewer should add LGTM[^1] as a comment.
...
[^1]: Acronym for "looks good to me".
